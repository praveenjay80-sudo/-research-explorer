...
const COL: Record<string, string[]> = {
  ...
  works:        ['np6024', 'np6025', 'np6023', 'np9623', 'np6022',
                 ...
                 'works_count', 'works', 'papers', 'publications', 'np'],
  cScore:       ['cns24', 'cns25', 'cns23', 'cns22', 'cns21', 'cns', 'c-score', 'cscore', 'composite score'],
...
function parseSheetData(headers: string[], dataRows: string[][]): {
  ...
  const rows: ParsedRow[] = dataRows.map((cells, i) => {
    ...
    return {
      ...
      citations: Math.round(num('citations')), hIndex: Math.round(num('hIndex')), works: Math.round(num('works')),
